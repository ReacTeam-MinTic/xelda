    ...
    <div className="row">
      ...
      <div className="col-lg-4">
        <div className="card gradient-bottom">
          ...
          <div className="card-body" id="top-5-scroll" tabIndex={2} style={{height: 315, overflow: 'hidden', outline: 'none'}}>
            <ul className="list-unstyled list-unstyled-border">
                ...
                <div className="media-body">
                  ...
                  <div className="mt-1">
                    <div className="budget-price">
                      <div className="budget-price-square bg-primary" data-width="64%" style={{width: '64%'}} />
                      <div className="budget-price-label">$68,714</div>
                    </div>
                    <div className="budget-price">
                      <div className="budget-price-square bg-danger" data-width="43%" style={{width: '43%'}} />
              ...
              <li className="media">
                ...
                <div className="media-body">
                  ...
                  <div className="mt-1">
                    <div className="budget-price">
                      <div className="budget-price-square bg-primary" data-width="84%" style={{width: '84%'}} />
                      <div className="budget-price-label">$107,133</div>
                    </div>
                    <div className="budget-price">
                      <div className="budget-price-square bg-danger" data-width="60%" style={{width: '60%'}} />
              ...
              <li className="media">
                ...
                <div className="media-body">
                  ...
                  <div className="mt-1">
                    <div className="budget-price">
                      <div className="budget-price-square bg-primary" data-width="34%" style={{width: '34%'}} />
                      <div className="budget-price-label">$3,717</div>
                    </div>
                    <div className="budget-price">
                      <div className="budget-price-square bg-danger" data-width="28%" style={{width: '28%'}} />
              ...
              <li className="media">
                ...
                <div className="media-body">
                  ...
                  <div className="mt-1">
                    <div className="budget-price">
                      <div className="budget-price-square bg-primary" data-width="45%" style={{width: '45%'}} />
                      <div className="budget-price-label">$13,972</div>
                    </div>
                    <div className="budget-price">
                      <div className="budget-price-square bg-danger" data-width="30%" style={{width: '30%'}} />
              ...
              <li className="media">
                ...
                <div className="media-body">
                  ...
                  <div className="mt-1">
                    <div className="budget-price">
                      <div className="budget-price-square bg-primary" data-width="35%" style={{width: '35%'}} />
          ...
          <div className="card-footer pt-3 d-flex justify-content-center">
            <div className="budget-price justify-content-center">
              <div className="budget-price-square bg-primary" data-width={20} style={{width: 20}} />
              <div className="budget-price-label">Selling Price</div>
            </div>
            <div className="budget-price justify-content-center">
              <div className="budget-price-square bg-danger" data-width={20} style={{width: 20}} />
            ...
            <div className="row">
              <div className="col-sm-6">
                ...
                <ul className="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                  <li className="media">
                    <img className="img-fluid mt-1 img-shadow" src="../node_modules/flag-icon-css/flags/4x3/id.svg" alt="image" width={40} />
                    <div className="media-body ml-3">
                      <div className="media-title">Indonesia</div>
                      <div className="text-small text-muted">3,282 <i className="fas fa-caret-down text-danger" /></div>
                    </div>
                  </li>
                  <li className="media">
                    <img className="img-fluid mt-1 img-shadow" src="../node_modules/flag-icon-css/flags/4x3/my.svg" alt="image" width={40} />
                    <div className="media-body ml-3">
                      <div className="media-title">Malaysia</div>
                      <div className="text-small text-muted">2,976 <i className="fas fa-caret-down text-danger" /></div>
                    </div>
                  </li>
                  <li className="media">
                    <img className="img-fluid mt-1 img-shadow" src="../node_modules/flag-icon-css/flags/4x3/us.svg" alt="image" width={40} />
                    <div className="media-body ml-3">
                      <div className="media-title">United States</div>
                      <div className="text-small text-muted">1,576 <i className="fas fa-caret-up text-success" /></div>
                    </div>
                  </li>
                </ul>
              </div>
              <div className="col-sm-6 mt-sm-0 mt-4">
                ...
                <ul className="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                  <li className="media">
                    ...
                    <div className="media-body ml-3">
                      <div className="media-title">Indonesia</div>
                      <div className="text-small text-muted">3,486 <i className="fas fa-caret-up text-success" /></div>
                    </div>
                  </li>
                  <li className="media">
                    <img className="img-fluid mt-1 img-shadow" src="../node_modules/flag-icon-css/flags/4x3/ps.svg" alt="image" width={40} />
                    <div className="media-body ml-3">
                      <div className="media-title">Palestine</div>
                      <div className="text-small text-muted">3,182 <i className="fas fa-caret-up text-success" /></div>
                    </div>
                  </li>
                  <li className="media">
                    <img className="img-fluid mt-1 img-shadow" src="../node_modules/flag-icon-css/flags/4x3/de.svg" alt="image" width={40} />
                    <div className="media-body ml-3">
                      <div className="media-title">Germany</div>
                      <div className="text-small text-muted">2,317 <i className="fas fa-caret-down text-danger" /></div>
                    </div>
                  </li>
                </ul>
              </div>
