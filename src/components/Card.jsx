...
const Card = ({children, titulo, subtitulo, ruta1, ruta2, ruta3, icon, fun, boton,}) => {
  return (
      ...
      <section class="section">
        ...
        <div class="section-body">
          ...
          <div class="card">
            ...
            <bottom onClick={fun} href="#" class="btn btn-lg btn-icon icon-left btn-primary"><i class={icon}></i> {boton}</bottom>
            </div>
            </div>
            <div class="card-body">
              <main>{children}</main>
